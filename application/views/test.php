...
<head>
    ...
    <title>手机版交友聊天社区网站模板下载_在线演示_手机网站模板_前端模板_js代码</title>
    <meta name="keywords" content="手机版,交友聊天,社区,网站模板,模板下载" />
    <meta name="description" content="手机版交友聊天社区网站模板下载。" />
...
<div id="dowebok">
    <ul class="nav">
        ...
        <li><a href="<?php echo base_url('demo/about_us');?>" style="background:url(../img/70%20Basic%20Icons-all-16.svg) 75px 30px no-repeat">关于我们</a></li>
